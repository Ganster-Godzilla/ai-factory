...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _p(e,t,n){return new jd({name:`SphericalGaussianBlur`,defines:{SAMPLES:np,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:bp(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vp(){return new jd({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:bp(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yp(){return new jd({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bp(),fragmentShader:`
	...
	`}var xp=class extends al{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new gd(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Km={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function qm(e,t){let n=Km[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Jm=new J;function Ym(){return X.getLuminanceCoefficients(Jm),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Jm.x.toFixed(4)}, ${Jm.y.toFixed(4)}, ${Jm.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
